...
export class Github
{
    ...
    api(realm, repo_url, relative_url = '', method = 'get', body = null, result = 'json')
    {
        ...
        return fetch(api + relative_url, Object.assign({method : method || 'get', headers : headers}, body != null ? {body : JSON.stringify(body)} : {})).then(resp => resp[result]().then(data => {result : res, ...resp}));
    }
