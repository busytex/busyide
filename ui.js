...
export class Shell
{
    ...
    bind()
    {
        ...
        this.ui.flatten_texmf.onclick = () => this.project_dir() && this.exists(this.PATH.join(this.project_dir(), this.texmf_local[0])) && this.commands(this.and(cmd('cd', this.project_dir()), cmd('mv', qx('find ' + arg(this.PATH.join(this.project_dir(), this.texmf_local[0])) + ' -type f'), '.'), cmd('find', this.texmf_local[0], '-empty', '-delete')));
