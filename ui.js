...
export class Shell
{
    ...
    bind()
    {
        ...
        this.ui.share.onclick = () => this.commands(chain('cd', cmd('nanozip', '-r', '-x', '.git', this.shared_project_zip, this.project_dir()), cmd('echo', '-n', this.ui.get_origin() + '/#base64zip/'), cmd('base64', '-w', '0', this.shared_project_zip), cmd('cd', '-')));
