...
export class Shell
{
    ...
    bind()
    {
        ...
        this.ui.rename.onclick = () => this.ui.current_file_rename.value ? (this.mv(this.ui.get_current_file(), this.ui.current_file_rename.value) || this.ui.set_current_file(this.ui.current_file_rename.value) || this.ui.toggle_current_file_rename()) : (this.ui.toggle_current_file_rename() || this.ui.current_file_rename.focus());
